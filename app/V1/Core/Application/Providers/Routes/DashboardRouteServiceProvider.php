...
abstract class DashboardRouteServiceProvider extends RouteServiceProvider
{
    ...
    protected string $prefixRouteName = 'admin.';

    protected string $additionalPrefix = 'dashboard-new/';
