...
return [
    ...
    'throttle' => 'Zbyt wiele prób. Spróbuj ponownie za chwilę.',
    'invalid_data' => 'Nieprawidłowe dane.',

    'password' => [
        'uppercase' => 'Hasło musi mieć co najmniej 8 znaków i zawierać przynajmniej 1 wielką literę.',
        'numeric' => 'Hasło musi mieć co najmniej 8 znaków i zawierać przynajmniej 1 cyfrę.',
        'special' => 'Hasło musi mieć co najmniej 8 znaków i zawierać przynajmniej 1 znak specjalny.',
        'uppercase_numeric' => 'Hasło musi mieć co najmniej 8 znaków i zawierać przynajmniej 1 wielką literę i 1 cyfrę.',
        'uppercase_special' => 'Hasło musi mieć co najmniej 8 znaków i zawierać przynajmniej 1 wielką literę i 1 znak specjalny.',
        'numeric_special' => 'Hasło musi mieć co najmniej 8 znaków i zawierać przynajmniej 1 cyfrę i 1 znak specjalny.',
        'all' => 'Hasło musi mieć co najmniej 8 znaków i zawierać przynajmniej 1 wielką literę, 1 cyfrę i 1 znak specjalny.',
        'compromised' => 'Hasło zostało skompromitowane w wyniku naruszenia danych.',
        'default' => 'Hasło musi mieć co najmniej 8 znaków.',
    ],
